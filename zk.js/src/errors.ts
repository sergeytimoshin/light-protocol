export enum UtxoErrorCode {
  ...
  ASSETS_AMOUNTS_LENGTH_MISMATCH = "ASSETS_AMOUNTS_LENGTH_MISMATCH",
}

export enum UserErrorCode {
  FETCHING_INDEXED_TRANSACTIONS_FAILED = "FETCHING_INDEXED_TRANSACTIONS_FAILED",
  ...
  COMPRESSED_RECIPIENT_UNDEFINED = "COMPRESSED_RECIPIENT_UNDEFINED",
  TOKEN_UNDEFINED = "TOKEN_UNDEFINED",
  INVALID_TOKEN = "INVALID_TOKEN",
  TRANSACTION_PARAMETERS_UNDEFINED = "TRANSACTION_PARAMETERS_UNDEFINED",
  ...
  INSTRUCTIONS_UNDEFINED = "INSTRUCTIONS_UNDEFINED",
  ACCOUNT_AND_SEED_PROVIDED = "ACCOUNT_AND_SEED_PROVIDED",
}

export enum SelectInUtxosErrorCode {
  INVALID_NUMBER_OF_MINTS = "INVALID_NUMBER_OF_MINTS",
...
export enum RpcErrorCode {
  RPC_FEE_UNDEFINED = "RPC_FEE_UNDEFINED",
...
export enum CreateUtxoErrorCode {
  INVALID_NUMBER_OF_RECIPIENTS = "INVALID_NUMBER_OF_RECIPIENTS",
  ...
  RPC_FEE_DEFINED = "RPC_FEE_DEFINED",
...
export enum TransactionParametersErrorCode {
  ...
  FETCHING_ROOT_FAILED = "FETCHING_ROOT_FAILED",
}
// TODO: clean up unused error codes
export enum TransactionErrorCode {
  NO_VERIFIER_IDL_PROVIDED = "NO_VERIFIER_IDL_PROVIDED",
  FIELD_NOT_FOUND = "FIELD_NOT_FOUND",
  IDL_CONSTANTS_UNDEFINED = "IDL_CONSTANTS_UNDEFINED",
  CIRCUIT_NOT_FOUND = "CIRCUIT_NOT_FOUND",
  INVALID_SYSTEM_PROGRAM_ID = "INVALID_SYSTEM_PROGRAM_ID",
  PROVIDER_UNDEFINED = "PROVIDER_UNDEFINED",
  ...
  WALLET_RPC_INCONSISTENT = "WALLET_RPC_INCONSISTENT",
  TX_PARAMETERS_UNDEFINED = "TX_PARAMETERS_UNDEFINED",
  APP_PARAMETERS_UNDEFINED = "APP_PARAMETERS_UNDEFINED",
  RPC_UNDEFINED = "TransactionParameters.rpc is undefined",
  WALLET_UNDEFINED = "WALLET_UNDEFINED",
